...
import { Heart, Calendar, CheckCircle, Clock, Plus, Edit, Trash2, Gift, Diamond, Flower, Camera } from 'lucide-vue-next'
...
const getCategoryInfo = (categoryValue: string) => {
    return props.categories.find(cat => cat.value === categoryValue) || props.categories[0]
}

const getPriorityInfo = (priorityValue: string) => {
    return props.priorities.find(p => p.value === priorityValue) || props.priorities[0]
}
            ...
            <div class="mx-auto max-w-6xl px-4 py-8">
                <Card class="mb-8 border-rose-200 bg-white/80 backdrop-blur-sm">
                    <CardHeader className="text-center">
                        <CardTitle className="text-2xl text-gray-800">Wedding Preparation Progress</CardTitle>
                            ...
                            <div class="flex items-start justify-between">
                                <div class="flex items-center gap-2">
                                    <Checkbox
                                        ...
                                        @update:checked="() => toggleTask(task)"
                                    />
                                    <Badge :class="getCategoryInfo(task.category).color" variant="secondary">
