...
<head>
    ...
    <meta property="og:site_name" content="Wedding Invitation - Khairul & Madihah">
    ...
    <style>
        ...
        * {
        ...
        .cover-section {
            min-height: 100vh;
            background-image: url('{{ asset('images/cover-bg-lelaki.jpeg') }}');
...
<body>
        ...
        <div class="contact-modal-content">
            ...
            <div class="contact-item">
                <div class="contact-info">
                    <p class="contact-name">Yaakub</p>
                </div>
                <div class="contact-buttons">
                    <a href="https://wa.me/601125054113" class="contact-btn" target="_blank">
                        <img src="{{ asset('images/icons/whatsapp.png') }}" alt="WhatsApp">
                    </a>
                    <a href="tel:+601125054113" class="contact-btn">
            ...
            <div class="contact-item">
                <div class="contact-info">
                    <p class="contact-name">Khairul</p>
                </div>
                <div class="contact-buttons">
                    <a href="https://wa.me/60179789587" class="contact-btn" target="_blank">
                        <img src="{{ asset('images/icons/whatsapp.png') }}" alt="WhatsApp">
                    </a>
                    <a href="tel:+60179789587" class="contact-btn">
                        <img src="{{ asset('images/icons/phone-call.svg') }}" alt="Phone">
                    </a>
                </div>
            </div>
    ...
    <div class="calendar-popup-modal" id="calendarPopupModal">
        <div class="calendar-popup-content">
            ...
            <p class="calendar-date-display">Isnin, 29 Disember 2025</p>
    ...
    <div class="location-modal" id="locationModal">
        <div class="location-modal-content">
            ...
            <div class="location-info">
                <p class="location-venue">Rumah Yaakub & Norizan</p>
                <p class="location-address">
                    Lot 1486 Desa Permai Kg Padang Bongor Binjai,<br>
                    16150 Kota Bharu, Kelantan
                </p>
            </div>

            <div class="location-buttons">
                <a href="https://maps.app.goo.gl/2pvReu3SeTe3Awgr5" class="location-btn" target="_blank">
                    <img src="{{ asset('images/icons/google.png') }}" alt="Google Maps">
                    Maps
                </a>
                <a href="https://www.waze.com/en/live-map/directions/my/kelantan/kota-bharu/rumah-yaakub-and-norizan?place=ChIJWYtXbwC7tjER4MHGPYXG0oo" class="location-btn" target="_blank">
    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <div class="parents-section animate-on-scroll">
                <p class="parent-name">YAAKUB BIN MAMAT</p>
                <p class="parent-name">&</p>
                <p class="parent-name">NORIZAN BINTI ISMAIL</p>
            </div>
            ...
            <div class="event-section animate-on-scroll">
                ...
                <p class="venue-name">Rumah Yaakub & Norizan</p>
            ...
            <div class="event-section animate-on-scroll">
                ...
                <p class="date-time-info">Isnin, 29 Disember 2025</p>
            </div>
    ...
    <script>
        ...
        function updateCountdown() {
            const weddingDate = new Date('2025-12-29T11:00:00+08:00');
            const now = new Date();
        ...
        function addToAppleCalendar() {
            const eventTitle = 'Walimatulurus - Khairul & Madihah';
            const eventLocation = 'Lot 1486 Desa Permai Kg Padang Bongor Binjai, 16150 Kota Bharu, Kelantan';
            const eventDetails = 'Walimatulurus Muhammad Khairul Imran bin Yaakub & Wan Madihah binti Mohamed Rusli';
            const startDate = '20251229T110000';
            const endDate = '20251229T180000';
...
END:VCALENDAR`;
            ...
            link.download = 'walimatulurus-khairul-madihah.ics';
        ...
        const weddingDate = new Date(2025, 11, 29); // December 29, 2025
